...
<div id="home" class="hero-area">
    ...
    <div class="home-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1 class="white-text">@lang('weblang.heroTitle')</h1>
                    <p class="lead white-text">@lang('weblang.heroDesc')</p>
                    @guest
                        <a class="main-button icon-button" href="{{ url('register') }}">@lang('weblang.getStartedBtn')</a>
                    @endguest
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="section-header text-center">
                <h2>@lang('weblang.popularExamsTitle')</h2>
                <p class="lead">@lang('weblang.popularExamsDesc')</p>
            </div>
        </div>
        <!-- /row -->
        ...
        <div class="row">
            <div class="center-btn">
                <a class="main-button icon-button" href="#">@lang('weblang.moreCoursesBtn')</a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2 text-center">
                <h2 class="white-text">@lang('weblang.contactTitle')</h2>
                <p class="lead white-text">@lang('weblang.contactDesc')</p>
                <a class="main-button icon-button" href="{{ url('contact') }}">@lang('weblang.contactBtn')</a>
            </div>
