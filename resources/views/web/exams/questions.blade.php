...
@section('main')
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						<ul class="hero-area-tree">
							...
							<li><a href="{{ url("/categories/show/{$exam->skill->id}") }}">{{ $exam->skill->name() }}</a></li>
							<li>{{ $exam->name() }}</li>
						</ul>
		...
		<div id="blog" class="section">
            ...
            <form id="exam-submit-form" action="{{ url("exams/submit/{$exam->id}") }}" method="post">@csrf</form>
						<!-- blog post -->
            ...
            <div>
                <button type="submit" form="exam-submit-form" class="main-button icon-button pull-left">@lang('weblang.subBtn')</button>
                <button class="main-button icon-button btn-danger pull-left ml-sm">@lang('weblang.cancelBtn')</button>
            </div>
					</div>
					<!-- /main blog -->
