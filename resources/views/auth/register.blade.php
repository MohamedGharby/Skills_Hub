				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						<ul class="hero-area-tree">
							...
							<li>{{ __('weblang.signup') }}</li>
						</ul>
						<h1 class="white-text">{{ __('weblang.signupHeader') }}</h1>
					...
					<div class="col-md-6 col-md-offset-3">
						<div class="contact-form">
							...
							<form method="POST" action="{{ url('register') }}">
								...
								<button type="submit" class="main-button icon-button pull-right">{{ __('weblang.signup') }}</button>
							</form>
						</div>
					</div>
					<!-- /login form -->
