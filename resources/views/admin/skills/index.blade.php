  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">SkillsHub Skills</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item active">SkillsHub Skills</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                      ...
                      <tbody>
                          @foreach ($skills as $skill)
                            <tr>
                                ...
                                <td>{{ $skill->name('ar') }}</td>
                                    @php
                                        $skill->img = str_replace('public/' , 'storage/' , $skill->img)
                                    @endphp
                                <td>
                                    <img src="{{ asset($skill->img) }}" height="50px" alt="{{ $skill->name('en') }}">
                                </td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-light" href="{{ url("dashboard/skills/toggle/$skill->id") }}">
                                        @if ($skill->active)
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          @include('admin.inc.errors')
            <form method="POST" action="{{ url('dashboard/skills/store') }}" enctype="multipart/form-data" id="submit-modal">
                @csrf
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control" id="category" name="cat_id">
                                @foreach ($cats as $cat)
          ...
          @include('admin.inc.errors')
            ...
            <form method="POST" action="{{ url('dashboard/skills/update') }}" enctype="multipart/form-data" id="edit-form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="edit-form-cat-id">Category</label>
